   ...
   const aiDefaultNameReplacements = [
    ...
    try {
        var theBuildConfig = deepMerge(buildConfig({
            "reactnative":          { 
                                        autoMinify: false,
                                        path: "./applicationinsights-react-native",
                                        cfg: {
                                            src: [
                                                "./applicationinsights-react-native/src/**/*.ts"
                                            ]
                                        },
        ...
        grunt.registerTask("default", ["ts:rollupuglify", "ts:default", "uglify:ai"]);

        grunt.registerTask("ai", tsBuildActions("reactnative"));
        grunt.registerTask("ai-min", minTasks("reactnative"));
        grunt.registerTask("ai-restore", restoreTasks("reactnative"));
        grunt.registerTask("aitests", tsTestActions("reactnative"));
        grunt.registerTask("ai-mintests", tsTestActions("reactnative", true));
